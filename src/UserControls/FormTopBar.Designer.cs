namespace Artube.src.UserControls
{
	partial class FormTopBar
	{
		...
		{
			this.formTopBarControlLogo1 = new Artube.src.UserControls.FormTopBarControlLogo();
			this.formTopBarControlLabelName1 = new Artube.src.UserControls.FormTopBarControlLabelName();
			this.formTopBarControlbtnXClose1 = new Artube.src.UserControls.FormTopBarControlbtnXClose();
			this.formTopBarControlbtnXMaximalize1 = new Artube.src.UserControls.FormTopBarControlbtnXMaximalize();
			this.formTopBarControlbtnXMinimalize1 = new Artube.src.UserControls.FormTopBarControlbtnXMinimalize();
			this.formTopBarControlbtnXHelp1 = new Artube.src.UserControls.FormTopBarControlbtnXHelp();
			this.formTopBarControlbtnXAppMessages1 = new Artube.src.UserControls.FormTopBarControlbtnXAppMessages();
			this.SuspendLayout();
			// 
			// formTopBarControlLogo1
			// 
			this.formTopBarControlLogo1.AutoSize = true;
			this.formTopBarControlLogo1.ImeMode = System.Windows.Forms.ImeMode.NoControl;
			...
			// 
			this.formTopBarControlLabelName1.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
			...
			// 
			this.formTopBarControlbtnXAppMessages1.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.Controls.Add(this.formTopBarControlbtnXMaximalize1);
			this.Controls.Add(this.formTopBarControlbtnXClose1);
			this.Controls.Add(this.formTopBarControlLabelName1);
		...
		private FormTopBarControlLogo formTopBarControlLogo1;
		private FormTopBarControlLabelName formTopBarControlLabelName1;
		private FormTopBarControlbtnXClose formTopBarControlbtnXClose1;
		private FormTopBarControlbtnXMaximalize formTopBarControlbtnXMaximalize1;
		private FormTopBarControlbtnXMinimalize formTopBarControlbtnXMinimalize1;
		private FormTopBarControlbtnXHelp formTopBarControlbtnXHelp1;
		private FormTopBarControlbtnXAppMessages formTopBarControlbtnXAppMessages1;
	}
}
