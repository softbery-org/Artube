		...
		protected override void WndProc(ref Message m)
		{
			...
			switch (m.Msg)
			{
				case WM_PAINT:
					...
					TextFormatFlags flags = TextFormatFlags.VerticalCenter | TextFormatFlags.HorizontalCenter | TextFormatFlags.SingleLine | TextFormatFlags.WordEllipsis;
